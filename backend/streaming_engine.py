...
(LUFS, peak, RMS, correlación estéreo, GR multibanda) para visualización
en vivo sin bloquear la interfaz.
"""
import numpy as np
...
def iter_mastering_chunks(audio: np.ndarray, sr: int,
    ...
    metrics_dict now includes multiband gain-reduction data from chain_meters.
    """
